...
if( $is_RUS ){ $fontName = 'timesnewromanpsmt'; 
...
if( $is_RUS ) { 
	...
	$STR = str_replace(array('&#36;', '&#1088;&#1091;&#1073;', '&#2547;', '&#82;', '&#1083;&#1074;', '&#75;&#269;', '&#8362;', '&#8365;', '&#8361;', '&#8358;', '&#8370;', '&#8369;', '&#122;&#322;', '&#3647;', '&#8378;', '&#8363;'),array('$', 'rub', 'BT', 'R', 'Lev', 'K', 'Sh', 'LK', 'Won', 'Naira', 'G', 'P', 'Zl', 'B', 'Lira', 'Dong' ), $STR); 
} 
elseif( $is_ENG ){
...
if( $is_ENG || $is_RUS ){
		...
		class PDF extends FPDF
		{
			function Header()
			{
				...
				$this->Ln(1);
				$this->Write(5, $header_text_4 ); $this->Ln(15);
			}
			function Footer()
			{
