...
<meta name=Generator content="WooCommerce PDF &amp; Print by">
...
'.get_option('wpp_save_doc_css').'

-->
</style>
</head>
<body link=blue vlink=purple style=\'tab-interval:35.4pt;text-align:'.get_option('wpp_save_text_align').'\'>
<div class=Section1 style="text-align:'.get_option('wpp_save_text_align').'">
	...
	' : '').''.(($wpp_sku) ? '<p style="font-size:16px;"><b>SKU</b>: '.$wpp_sku.'</p>
	' : '' ).''.(($wpp_stock) ? '<p style="font-size:16px;"><b>In stock</b>: '.$wpp_stock.'</p>
	' : '' ).''.(($wpp_rating) ? '<p style="font-size:16px;"><b>Rating</b>: '.$wpp_rating.'</p>
	' : '' ).''.(($wpp_categories) ? '<p style="font-size:16px;"><b>Product Categories</b>: '.$wpp_categories.'</p>
	' : '' ).''.(($wpp_tags) ? '<p style="font-size:16px;"><b>Product Tags</b>: '.$wpp_tags.'</p>
	' : '' ).''.(($wpp_permalink) ? '<p style="font-size:16px;"><b>Product Page</b>: <a href="'.$wpp_permalink.'">'.$wpp_permalink.'</a></p>
	' : '' ).'
...
<p><o:p>&nbsp;</o:p></p>
		...
		<p style="background:#F9F9F9">
			<span style=\'font-size:9.0pt;color:#000000;\'>
			Powered by [ WooCommerce PDF &amp; Print ] plugin. MS Word saving format developed by gVectors Team
			</span>
			<span style=\'font-size:9.0pt;color:#000000\'>
...
function wpp_doc_tabs($title_html, $content_html){
