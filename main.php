...
function wpp_install () {
   ...
   //------------- Adding Options ----------------------------//
	...
	if( get_option('wpp_installed') == '' ){ 
		...
		//update_option( 'wpp_save_doc_button_type', 0 );
		//update_option( 'wpp_save_pdf_button_type', 0 );
		//update_option( 'wpp_save_print_button_type', 0 );
		...
		update_option( 'wpp_save_print_button_text', 'Print this Post' );
	...
	if( get_option('pppm_installed') !='1.0.1' ){
		///////////////////////////////////////////////
		update_option( 'pppm_installed', '1.0.1' ); //
		///////////////////////////////////////////////
	}
